...
$localized = array(
	...
	'social_connect:connect:connect_with' => 'Vaihtoehtoiset kirjautumistavat:',
	'social_connect:connect:privacy' => 'Privacy',
	'social_connect:connect:all_disabled' => 'Sivuston ylläpitäjä on ottanut tämän toiminnon pois käytöstä.',

	'social_connect:error:title' => 'Yhteyden muodostaminen epäonnistui',
	'social_connect:error:unknown' => 'Tuntematon virhe.',
	'social_connect:error:hybrid_auth_configuration' => 'HybridAuth on konfiguroitu väärin.',
	'social_connect:error:provider_configuration' => 'Palveluntarjoaja on kofiguroitu väärin.',
	'social_connect:error:invalid_provider' => 'Palveluntarjoaja on tuntematon tai poistettu käytöstä.',
	'social_connect:error:missing_credentials' => 'Palveluntarjoajan vaatimat tunnistetiedot puuttuvat.',
	'social_connect:error:connection_refused' => 'Tunnistautuminen epäonnistui. Yhteyden muodostaminen keskeytettiin, tai palveluntarjoaja hylkäsi pyynnön.',

	'social_connect:register:bad' => 'Rekisteröityminen palvelulla %s epäonnistui.',
	'social_connect:register:ok' => 'Rekisteröityminen %s-tililläsi onnistui.',
	'social_connect:register:not_allowed' => 'Sivuston ylläpitäjä on ottanut tämän toiminnon pois käytöstä.',
	'social_connect:connect:ok' => 'Käyttäjätilisi on yhdistetty %s-tiliisi.',
	'social_connect:connect:emailnotfound' => 'The email address provided by %s is not registered with Elgg yet',
	'social_connect:login:ok' => 'Kirjauduit onnistuneesti %s-tililläsi',
	'social_connect:login:bad' => 'Kirjautuminen %s-tilillä epäonnistui',
	'social_connect:login:not_allowed' => 'Tämä toiminto ei ole käytössä',
	'social_connect:authenticate:loading' => 'Ladataan...',
	'social_connect:authenticate:contacting' => 'Yhdistet&auml;&auml;n palveluun <b>%s</b>. Odota, ole hyv&auml;.',
	// Email notifications
